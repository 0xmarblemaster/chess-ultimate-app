/**
 * Admin gamification ranks proxy (Ranks tab).
 * Clerk-gated → forwards to Flask `/api/admin/.../gamification/ranks`.
 */
...
async function forward(
  ...
  const res = await fetch(
    `${BACKEND_URL}/api/admin/organizations/${orgId}/gamification/ranks`,
    {
      method,
