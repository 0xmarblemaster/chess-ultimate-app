...
# Legacy ETL/RAG answer-agent and conversation-memory stack removed: the
# `etl` package never existed in this repo, so these imports always failed and
# the agent stayed None. The kept /api/chat endpoint returns 503 when it is None.
answer_agent_instance = None
